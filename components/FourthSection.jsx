...
const ThirdSection = ({ containerRef, horizontalTween }) => {
  ...
  useEffect(() => {
    ...
    gsap.to(imageRef.current, {
      scale: 1.8, // Zoom from initial scale (1) to 1.2
      ease: 'none',
      scrollTrigger: {
    ...
    const textStartScroll = pinStart + 4.1 * V;
    ...
    const imageStartScroll = pinStart + 4.3 * V;
  ...
  return (
    <section className='third-section-wrapper'>
      ...
      <div className="third-section-image-wrapper">
        <div ref={imageRef} className="image-container-2" />
      </div>
    </section>
  );
};
